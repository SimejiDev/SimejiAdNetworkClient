...
@class SANRewardedInterstitialAd;
...
typedef void (^SANRewardedInterstitialAdLoadCompletionHandler)(
    SANRewardedInterstitialAd *_Nullable rewardedInterstitialAd, NSError *_Nullable error);
...
@interface SANRewardedInterstitialAd : NSObject <SANAdMetadataProvider, SANFullScreenPresentinSAN>
...
+ (void)loadWithAdUnitID:(nonnull NSString *)adUnitID
       ...
       completionHandler:(nonnull SANRewardedInterstitialAdLoadCompletionHandler)completionHandler;
